...
| 17 | Coroa ×4 + passe de FORMA (dono, jul/04, decidido sobre a anatomia medida + probe A/B) | **Ring Closes 54→300 (×4)** — ponto ótimo empírico (compra −8h, fica 1 degrau abaixo do First Light ×5; 700 destronaria o rito e só compraria −2h a mais); Okhra re-fita no par (a 1520 com coroa 300 caía pra 19 golpes). **Passe de forma:** suavizar morro G2–G3 (convs 5–6 de 6.9–9.4h → ~4–5h) · Porto volta a morder (G4–G5 de 1.6–2h → ~4–6h cada, re-fit das áreas 10–15 sobre o poder pós-coroa) · matar o deserto pré-FL (12–15h sem evento): drop de material ESCALA por área no G6 (16→18) pra reta final acelerar, FL ~conv 14. Âncora do relógio: o dono decide sobre o total re-medido (~45–50h estimado) |
| 18 | Golden Wake = jackpot 15× (dono, playtest v9-r4) | A folha vira **X% de chance de Lumens 15×** (cap ~10% — "10% de chance de vir 15×"), no lugar do dobro. Fecha a ESCADA de apostas do eixo Lumens: Twice-Gilded 2× (primário) → Fortune's Torrent 4× (assinatura) → Golden Wake 15× (folha, topo). Orçamento conjunto re-derivado (média +140% no cap — goldRatio/custos absorvem no fit). Lore line atualiza. PRÓXIMA ITERAÇÃO (v9-r6 — não interromper o r5) |
| 19 | Pilgrim's Wisdom em níveis GORDOS (dono, playtest v9-r4) | "+22.5%/nível é muito pouco" → menos níveis, mais caros, cada um percebido: ~5 níveis de +60–80% XP (orçamento total ≈ mantido; o que muda é ritmo e percepção de compra). Candidato a padrão pra outras folhas de % se o playtest gostar. v9-r6 |
| 20 | Redistribuição dos 6.000 níveis — ✅ RESOLVIDA: deixar como está | Decidido pelo dono sobre o r5 medido: a vontade era sintoma da forma quebrada, e a forma sarou por outras alavancas. Reabre pontual só se playtest apontar área com níveis de menos/demais |
| 22 | Threshold do Harbinger em ESCADA GEOMÉTRICA (dono, jul/04 — "+20/grupo é muito pouco") | Substituir base+perGroup por escada explícita POR GRUPO: **[200, 500, 1000, 2000, 4000, 8000]** (G1→G6; forma "200 depois 500, 1k, etc" do dono — ~×2 a ×2.5 por degrau; o fit pode ajustar os degraus finais MANTENDO a forma geométrica). Gates: (a) cadência de Marcos não quebra — cada Harbinger alcançável dentro da janela do seu grupo; (b) H6 invocável a tempo do finale (kills/h do G6 pós-coroa × janela de 11.5h ≥ threshold, com regrind 1.0); (c) fluxo de awakenMaterial de boss re-medido (menos bosses/h = menos material de boss — matAreaMult compensa se precisar). v9-r7 |
| 25 | GATE: gear é o caminho da vitória (dono, playtest r7 jul/04: "devo ganhar SOMENTE upando o gear; mobs subindo HP não geram tensão") | Dois gates empíricos novos, medir PÓS-r8 (o vazamento de XP mascara ambos): (a) **persona no-gear trava na área 2–4** (probe: sim com compra de gear desligada — se passar da área 4, o flat de nível está gordo demais → rebaixar playerAtkCoef/Exp e re-fitar); (b) **tensão de combate early**: TTD na banda do G1–G2 apertado o bastante pra mob importar (morte possível em descuido de entrada, não só em entrada prematura profunda). Se (a) falhar, vira dial; se (b) falhar, mob ATK early sobe no fit |
| 24 | Granularidade de level-up (dono, playtest r7 jul/04: "level up já me dá 3 níveis de cara — não pode") | **GATE NOVO: 1 kill concede no MÁXIMO 1 nível, sempre.** Causa: baseXp 245 vs custos iniciais 14/52/113 (14×L^1.9). Fix via mini-fit do par (xpCurveBase, xpCurveExp) — sobe o custo early, re-equilibra o expoente; relógio preservado (1ª conv ~40min ±20% · FL 38h25–44 ±30min · demais gates intactos). v9-r8 |
| 23 | Copy do contador de invocação (dono, jul/04) | **"{Boss} manifests in N kills"** substitui "{Boss} stirs in N kills" (P8.5b) — com a escada da var 22 o contador virou jornada, e "manifests" unifica com o verbo canônico da invocação (Okhra manifesta). Implementar junto do v9-r7 (ui-hud) |
| 21 | Resoluções dos conflitos do r5 (dono, jul/04) | (1) Okhra seed-alta 107 golpes ACEITO (regra "erra pro lado alto"; Siphoning é não-linear por natureza) · (2) **G6 ganha PAREDE PARCIAL: entrada das áreas 16–18 em HTK ~3–5** (nem 8–12 nem 0.7 — a Garganta volta a ser atrito sem matar a colheita; clear estica pra ~38–40h, janela de material re-fita) · (3) morro G2–G3 fica no teto seguro (xpMult 2.3; 2.6 = death loop medido) |
