...
| 20 | Redistribuição dos 6.000 níveis pelas 18 áreas (dono — ABERTA) | levelRanges alimentam o gerador da família; o dono cogita redistribuir e/ou AUMENTAR o teto. Decidir a forma DEPOIS do relatório do v9-r5 (o passe de forma pode já resolver o que incomoda). Se aumentar: xpCurve/gates/coroa re-fitam em cascata |
