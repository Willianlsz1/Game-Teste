...
- **P8.5 (jul/2026, achado do playtest do H1): ✅** — `bossRegrindFrac 0.2` mata o farm infinito de Harbinger (re-invocar = re-farmar ~20% do threshold); relógio re-validado 18h29–18h34 seeds 1/3/7 (alvo P0 18h); finale H6→Okhra intacto; UI ganhou identidade de boss (tag HARBINGER dourada) + Lightshell legível (badge/aura/floater/log). Âncoras novas SUBSTITUEM as do P8 (17h01–17h13 era abaixo do alvo).
