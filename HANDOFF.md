...
- **PASSO 2 (Fricção): EM ANDAMENTO, FATIADO** — 2.1 TTK-alvo ✅ (Opção A, em golpes) → 2.2 freio F3 ✅ (A+C) → 2.3 curvas HP ✅ (C3 Gaiadon-híbrido) → 2.4 dano/ondas/morte → 2.5 threshold+boss mults. Travar cada sub em conversa; IMPLEMENTAR TUDO JUNTO no fim (decisão do Willian).
...
1. **P2.4** — dano dos mobs, ondas por grupo, papel da morte (opções na mesa).
